    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.ImageField(blank=True, default=None, null=True, upload_to='', verbose_name='image url')),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='created at')),
                ('telegram_id', models.CharField(blank=True, default=None, max_length=20, null=True, verbose_name='telegram id')),
