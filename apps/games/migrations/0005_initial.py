...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('games', '0004_remove_player_game_remove_player_user_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('O', 'Opened'), ('S', 'Started'), ('F', 'Finisehd'), ('C', 'Closed')], default='O', max_length=1, verbose_name='Game status')),
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='game', to='teams.team')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
